...
DG.add_weighted_edges_from([("action.Hacking", "action.Bugs", random()),
                            ...
                            ("emp_ord", "action.Malware", random()),
                            ("emp_ord", "action.Hacking", random()),
                            ("emp_ord", "action.Physical", random()),
                            ("emp_ord", "action.Misuse", random()),
                            ("emp_ord", "action.Error", random()),
                            ("emp_ord", "action.Environmental", random()),
                            ("emp_ord", "action.Social", random()),
